...
public class UserService extends ServiceManager<User, Long> {
        ...
        public UserService(IUserRepository userRepository, IElasticServiceManager elasticServiceManager) {
        ...
        public Boolean saveDto(UserSaveRequestDto dto) {
                User user = IUserMapper.INSTANCE.userFromUserSaveRequestDto(dto);
                save(user);
                elasticServiceManager.save(IUserMapper.INSTANCE.userProfileSaveRequestDtofromUser(user));
                return true;
        }
